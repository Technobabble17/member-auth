<nav class="bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-600">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <div class="group overflow-clip relative h-12 md:w-1/3">
            <a href="{{ route('home') }}" class="flex group/button items-center space-x-3">
        ...
        <div class="flex items-center md:order-2 md:w-1/3 space-x-3 md:space-x-0 md:justify-end gap-4">
        ...
        <div id="navbar-sticky" class="md:w-1/3 items-center justify-between hidden max-md:w-full md:flex md:justify-center md:order-1">
            <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border rounded-lg md:space-x-8 md:flex-row md:mt-0 md:border-0 bg-gray-800 md:bg-gray-900 border-gray-700">
                <li>
                    <a href="/" class="block {{ request()->is('/') ? 'link-active' : 'link' }}">Home</a>
                </li>
                @if (Auth::guard('members')->check())
