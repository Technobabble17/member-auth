...
@section('content')
    ...
    <div class="max-w-md mx-auto rounded bg-gray-700 p-8 mt-8 pb-16 overflow-hidden shadow shadow-blue-600">
        <form action="{{ route('member.register') }}" method="post" class="">
            ...
            <button type="submit"
                class="absolute text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700">Submit</button>
        </form>
        @if ($errors->any())
            <div class="mt-24">
